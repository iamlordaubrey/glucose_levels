    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('non_numeric_rapid_acting_insulin', models.CharField(blank=True, max_length=200, null=True)),
                ('rapid_acting_insulin', models.IntegerField(blank=True, null=True)),
                ('non_numeric_nutritional_data', models.CharField(blank=True, max_length=200, null=True)),
                ...
                ('non_numeric_depot_insulin', models.CharField(blank=True, max_length=200, null=True)),
